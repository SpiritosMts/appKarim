    ...
    return DefaultTabController(
      ...
      child: Scaffold(
                ...
                child: Container(
                  child: Column(
                    ...
                    children: [
                      ...
                      prop('Total Expenses:'.tr, '${formatNumberAfterComma2(wrkCtr.selectedWorker.totalExpenses!)}',color: Colors.redAccent,extraTxt: '$currency'),
                      prop('Total Kridi:'.tr, '${formatNumberAfterComma2(wrkCtr.selectedWorker.totalKridi!)}',color: Colors.greenAccent,extraTxt: '$currency'),
        ...
        floatingActionButton: customFAB(
          text: 'return Kridi'.tr,
          icon: Icons.attach_money,
          onPressed: () {
            showAnimDialog(wrkCtr.returnKridiDialog());
