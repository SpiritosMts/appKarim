...
import '../myVoids.dart';
import '../notifications/awesomeNotif.dart';
import 'login.dart';
import 'registerSelectType.dart';
    ...
    chatStream = FirebaseFirestore.instance
      ...
      if(messages.isNotEmpty){
        ...
        if (sender != authCtr.cUser.name) {
          ...
          if(!firstSend) {
            NotificationController.createNewNotification('${sender}', '${contain}');
      ...
      if(doctorAppoi.isNotEmpty && doctorAppoi['fuxNHBtnC1TmCbmgSjkH'] != null){
        ...
        if (authCtr.cUser.role == 'doctor') {
          if(appoiOnlineNum == appoiLocalNum + 1){
            ...
            NotificationController.createNewNotification('${sender}', 'want to schedule a meeting at ${time}');
          }
        }else{
          if(showAcceptance){
            for (var key in doctorAppoi.keys) {
              if (key == authCtr.cUser.id) {
                ...
                if (patAppoi['new'] == false) {
                  ...
                  NotificationController.createNewNotification('${authCtr.cUser.name}', 'your doctor has accepted your meeting request');
