...
import 'package:gajgaji/main.dart';
              ...
              SettingsTile.switchTile(
                onToggle: (value) {
                  setState(() {
                    ...
                    themeCtr.onSwitch(value);
                  });
                },
                initialValue: !themeCtr.isLightTheme,
                  ...
                  showChangeProp(
                      ...
                      btnOkPress: (){
                        if (emailFormKey.currentState!.validate()) {
                          changeUserEmail(newEmailCtr.text,usersColl);
                          newEmailCtr.clear();
                          Get.back();
                        }
                      }
                  ...
                  showChangeProp(
                    ...
                    btnOkPress: (){
                      if (nameFormKey.currentState!.validate()) {
                        changeUserName(newNameCtr.text,usersColl);
                        newNameCtr.clear();
                        Get.back();
                      }
                    }
                  ...
                  showChangeProp(
                      ...
                      btnOkPress: (){
                        if (pwdFormKey.currentState!.validate()) {
                          changeUserEmail(newPwdCtr.text,usersColl);
                          newPwdCtr.clear();
                          Get.back();
                        }
                      }
